...
class AuthorRegisterTest(AuthorBaseTest):
    ...
    def form_field_test_with_callback(self, callback):
        ...
        form.find_element(By.NAME, 'email').send_keys('email@mmail.com')
    ...
    def test_password_do_not_match(self):
        def callback(form):
            ...
            password_field1.send_keys('abCDde223//')
            password_field2.send_keys('abcde223')
    ...
    def test_user_valid_data_register_successfully(self):
        ...
        self.get_by_placeholder(
            form, 'Your e-mail').send_keys('email@gmail.com')
        self.get_by_placeholder(
            form, 'Type your password').send_keys('P@asSw0rd123')
        self.get_by_placeholder(
            form, 'Repeat your password').send_keys('P@asSw0rd123')
        form.submit()
