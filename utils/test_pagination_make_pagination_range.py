...
class MakePaginationRangeTest(TestCase):
    ...
    def test_first_range_is_static_if_current_page_is_less_than_middle_page(self):  # noqa: E501
        # Current-page = 1 Qty-page = 4 Middle-page = (qty_pages / 2)
        pagination = make_pagination_range(
            page_range=list(range(1, 21)),
            qty_pages=4,
            current_page=1,
        ...
        # Current-page = 2 Qty-page = 4 Middle-page = (qty_pages / 2)
        pagination = make_pagination_range(
            page_range=list(range(1, 21)),
            qty_pages=4,
            current_page=2,
        ...
        # Current-page = 3 Qty-page = 4 Middle-page = (qty_pages / 2)
        ...
        # Current-page = 4 Qty-page = 4 Middle-page = (qty_pages / 2)
        # HERE RANGE SHOULD CHANGE
        pagination = make_pagination_range(
            page_range=list(range(1, 21)),
            qty_pages=4,
    ...
    def test_make_sure_middle_ranges_are_correct(self):
        # Current-page = 10 Qty-page = 4 Middle-page = (qty_pages / 2)
        # HERE RANGE SHOULD CHANGE
        pagination = make_pagination_range(
            page_range=list(range(1, 21)),
            qty_pages=4,
